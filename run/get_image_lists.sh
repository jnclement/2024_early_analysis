...
for i in {0..9999}; do
    echo $i
    ls /sphenix/tg/tg01/jets/jocl/evt/$i/*20250123_jet10* >> lists/jet10.imagelist
done

for i in {0..9999}; do
    echo $i
    ls /sphenix/tg/tg01/jets/jocl/evt/$i/*20250123_jet30* >> lists/jet30.imagelist
done

for i in {0..99999}; do
    echo $i
    ls /sphenix/tg/tg01/jets/jocl/evt/$i/*20250123_mb* >> lists/mb.imagelist
done
